INSERT INTO `region` (`id_region`,`nombre`,`capital`)
VALUES
	...
	(6,'Valparaiso','valparaíso'),
	(7,'Metropolitana de Santiago','Santiago'),
	(8,'Libertador General Bernardo O Higgins','Rancagua'),
	(9,'Maule','Talca'),
	(10,'Ñuble','Chillán'),
	(11,'Biobío','Concepción'),
	(12,'La Araucanía','Temuco'),
	(13,'Los Ríos','Valdivia'),
	(14,'Los Lagos','Puerto Montt'),
	(15,'Aysén del General Carlos Ibáñez del Campo','Coyhaique'),
	(16,'Magallanes y de la Antártica Chilena','Punta Arenas');


    INSERT INTO `provincia` (`id_provincia`,`nombre`,`id_region`)
VALUES
	(1,'Arica',1),
	(2,'Parinacota',1),
	(3,'Iquique',2),
...
INSERT INTO `comuna` (`id_comuna`,`nombre`,`id_provincia`)
VALUES
	(1,'Arica',1),
	(2,'Camarones',1),
	(3,'General Lagos',2),
